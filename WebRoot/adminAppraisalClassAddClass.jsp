...
<div class="stdContainer">
	<h1>
		<bean:message key="admin.appraisalmanager.class.add" />
	</h1>
	<br />
	
	<%-- <div class="errors"><html:errors /><br /></div> --%>
	
	<logic:notEmpty name="appClassForm" property="infoMessage">
		<span class="infomessage">
			<bean:message name="appClassForm" property="infoMessage"/>
		</span>
		<br />
		<br />
	</logic:notEmpty>
	...
	<html:form action="classEdit">
		...
		<br />
		<br />
		<html:checkbox name="appClassForm" property="reuse" value="1">&nbsp;<bean:message key="common.reuse" /></html:checkbox>
		<br />
		<br />
