...
public class RolesDAO extends BaseHibernateDAO {
	...
	public static final String REPORTMANAGER = "reportmanager";
	public static final String APPRAISALMANAGER = "appraisalmanager";
	...
	public Roles findById(java.lang.Integer id) {
		...
		try {
			Roles instance = (Roles) getSession().get("com.wub.db.Roles", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Roles instance) {
		...
		try {
			List results = getSession().createCriteria("com.wub.db.Roles").add(
	...
	public List findByUsermanager(Object usermanager) {
		return findByProperty(USERMANAGER, usermanager);
	}

	public List findByReportmanager(Object reportmanager) {
		return findByProperty(REPORTMANAGER, reportmanager);
	}

	public List findByAppraisalmanager(Object appraisalmanager) {
		return findByProperty(APPRAISALMANAGER, appraisalmanager);
	}
